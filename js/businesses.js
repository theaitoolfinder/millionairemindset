...
const BUSINESSES = [
  {
    ...
    cta1: { label: 'Shop JC Premiere Products', href: 'shop.html' },
  ...
  },
  {
    ...
    cta1: { label: 'Take Financial Check-up First', href: 'checkup.html' },
  ...
  },
  {
    ...
    cta1: { label: 'Inquire About Properties', href: 'index.html#contact' },
